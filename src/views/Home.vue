        ...
        <b-tabs card>
          <b-tab title="Flights" active>
            <b-row class="mb-4">
              <b-col>
                <b-row class="align-items-center">
                  ...
                  <b-col cols="8"><b-form-input v-model="from" id="from" type="text" placeholder="Enter an airport or city"></b-form-input></b-col>
                </b-row>
              </b-col>
              <b-col>
                <b-row class="align-items-center">
            ...
            <b-row class="my-4">
              <b-col>
                <b-row class="align-items-center">
                  ...
                  <b-col cols="8"><b-form-input v-model="to" id="from" type="text" placeholder="Enter an airport or city"></b-form-input></b-col>
                </b-row>
              </b-col>
              <b-col>
            ...
            <b-row class="mt-4">
              ...
              <b-col><b-button type="submit" variant="primary" class="float-right" @click="searchNow">Search Now!</b-button></b-col>
            </b-row>
          </b-tab>
          <b-tab title="Hotels">
            not implemented
